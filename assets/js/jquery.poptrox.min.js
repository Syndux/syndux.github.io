    ...
    (e.fn.poptrox = function (o) {
            ...
            .on("startSpinning", function (o) {
              ...
              t
                ...
                .css(
                  "margin-top",
                  Math.floor(
                    (x.height() - t.height() + (m.length > 0 ? m.height() : 0)) / 2
                  )
                )
      ...
      return (
        ...
        C.css("cursor", "pointer").on("click", function (e) {
          return (
            e.preventDefault(), e.stopPropagation(), x.trigger("poptrox_close"), !0
          );
        }),
          ...
          .on("poptrox_switch", function (o, t, p) {
            ...
            if (
              ...
              (r = i.width),
                (n = i.height),
                "%" == r.slice(-1) &&
                  (r = (parseInt(r.substring(0, r.length - 1)) / 100) * l.width()),
                "%" == n.slice(-1) &&
                  (n = (parseInt(n.substring(0, n.length - 1)) / 100) * l.height()),
                w
                  .css("position", "relative")
                  .css("outline", "0")
